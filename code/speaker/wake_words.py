...
# your wake word to define them.  "hey gpt f[chat_with_llm_chatgpt]" means
...
wake_words = [
            ...
            "Take care and",
            "hey aaron",
            "hey gpt f[chat_with_llm_chatgpt]",
            "agpt f[chat_with_llm_chatgpt]",
            "a gpt f[chat_with_llm_chatgpt]",
            "hey gp f[chat_with_llm_chatgpt]",
            "hey jeep f[chat_with_llm_chatgpt]",
            "hey gee f[chat_with_llm_chatgpt]",
            "h-g-b-t f[chat_with_llm_chatgpt]",
            "h-g-p-t f[chat_with_llm_chatgpt]",
            "hey chatgpt f[chat_with_llm_chatgpt]"
            "hey chat gpt f[chat_with_llm_chatgpt]",
            "hey claude f[chat_with_llm_claude]",
            "hey clive f[chat_with_llm_claude]",
            "hey clyde f[chat_with_llm_claude]",
            "hey quad f[chat_with_llm_claude]",
            "they clawed f[chat_with_llm_claude]",
            "hey claude opus f[chat_with_llm_claude_opus]",
            "hey opus f[chat_with_llm_claude_opus]",
            "hey claude sonnet f[chat_with_llm_claude_sonnet]",
            "hey sonnet f[chat_with_llm_claude_sonnet]",
            "hey claude haiku f[chat_with_llm_claude_haiku]",
            "hey haiku f[chat_with_llm_claude_haiku]",
            "a claude f[chat_with_llm_claude]",
            "hey clod f[chat_with_llm_claude]",
            "a clawed f[chat_with_llm_claude]",
            "hey clawed f[chat_with_llm_claude]",
            "a clod f[chat_with_llm_claude]",
            "hey clyde f[chat_with_llm_claude]",
            "hey tools bot f[tools_bot]",
            "hey tool spot f[tools_bot]",
            "hey tools f[tools_bot]",
            "hey tool f[tools_bot]",
            "hey dolphin f[chat_with_llm_dolphin]",
